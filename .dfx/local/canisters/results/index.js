...
import { idlFactory } from './results.did.js';
export { idlFactory } from './results.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_RESULTS;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./results.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the results canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./results.did.js")._SERVICE>}
 */
export const results = createActor(canisterId);
